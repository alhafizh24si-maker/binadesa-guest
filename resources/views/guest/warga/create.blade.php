          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-8 mx-auto text-center">
                ...
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Tambah Data Warga</h2>
                <p data-aos="fade-up" data-aos-delay="200">Form untuk menambahkan data warga baru ke dalam sistem.</p>
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <div class="form-wrapper" data-aos="fade-up" data-aos-delay="300">
                  <form action="{{ route('warga.store') }}" method="POST" class="p-5 rounded-4" style="background: var(--bs-body-bg); border: 1px solid var(--bs-border-color);">
                    @csrf
