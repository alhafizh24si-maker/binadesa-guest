        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="row">
                                <div class="col-lg-11">
                                    <span class="hero-subtitle text-uppercase d-block mb-2" data-aos="fade-up" data-aos-delay="0">Platform Desa Digital</span>
                                    <h1 class="hero-title mb-3 display-4 fw-bold" data-aos="fade-up" data-aos-delay="100">Selamat Datang di Binadesa!</h1>
                                    <p class="hero-description mb-4 mb-lg-5 fs-5" data-aos="fade-up" data-aos-delay="200">Platform digital terdepan yang menghubungkan warga dengan informasi dan layanan desa secara modern dan efisien.</p>
                                    ...
                                    <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400">
                                        <span class="logos-title text-uppercase mb-4 d-block">Dipercaya oleh desa-desa</span>
                        ...
                        <div class="col-lg-6">
                            <div class="hero-img position-relative">
                                <img class="img-main img-fluid rounded-4 shadow-lg" src="{{ asset('assets-guest/images/hero-img-desa.jpg') }}" alt="Hero Image" data-aos="fade-in" data-aos-delay="500">
                            ...
                            <div class="row g-4">
                                <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
                                    <div class="stats-card">
                                        ...
                                        <h3 class="fs-1 fw-bold">
                                            <span class="purecounter" data-purecounter-start="0" data-purecounter-end="1250" data-purecounter-duration="2">0</span>
                                            <span>+</span>
                                        </h3>
                                ...
                                <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                                    <div class="stats-card">
                                        ...
                                        <h3 class="fs-1 fw-bold">
                                            <span class="purecounter" data-purecounter-start="0" data-purecounter-end="156" data-purecounter-duration="2">0</span>
                                            <span>+</span>
                                        </h3>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            ...
                            <h2 class="section-title text-center mb-3" data-aos="fade-up" data-aos-delay="100">Mengenal Binadesa Lebih Dekat</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Platform digital inovatif yang didedikasikan untuk memajukan desa melalui teknologi.</p>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="0">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Menjadi platform digital terdepan dalam menghubungkan warga dengan informasi dan layanan desa, menciptakan masyarakat desa yang modern, transparan, dan sejahtera.</p>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Menyediakan platform yang mudah digunakan, aman, dan efisien untuk mengelola informasi desa, meningkatkan partisipasi warga, dan mendukung pembangunan desa yang berkelanjutan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            ...
                            <h2 class="section-title text-center mb-3" data-aos="fade-up" data-aos-delay="100">Apa yang Bisa Anda Temukan di Binadesa</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Berbagai fitur menarik yang membuat pengelolaan desa menjadi lebih mudah dan modern.</p>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Akses informasi terbaru seputar kegiatan, pengumuman, dan perkembangan desa secara real-time.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Pantau jadwal kegiatan desa, acara masyarakat, dan agenda penting lainnya dengan mudah.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Permohonan surat dan layanan administrasi desa dapat dilakukan secara online.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Pantau perkembangan program pembangunan desa dan kontribusi Anda dalam memajukan desa.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Berdiskusi dan berbagi informasi dengan sesama warga dalam forum komunitas yang aman.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div class="feature-card">
                                ...
                                <p class="mb-0">Akses semua fitur melalui perangkat mobile kapan saja dan di mana saja.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section bg-light" id="news">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            <span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Berita Terkini</span>
                            <h2 class="section-title text-center mb-3" data-aos="fade-up" data-aos-delay="100">Informasi Terbaru dari Desa</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Update terbaru seputar kegiatan dan perkembangan desa.</p>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                            <div class="news-card">
                                <img src="{{ asset('assets-guest/images/bansos.jpg') }}" class="card-img-top" alt="Berita 1" style="height: 200px; object-fit: cover;">
                                <div class="card-body p-4">
                                    <span class="badge bg-primary mb-2">Pengumuman</span>
                                    <h5 class="card-title">Program Bantuan Sosial Tahap II</h5>
                                    <p class="card-text text-muted">Pendaftaran program bantuan sosial tahap II akan dibuka mulai tanggal 15 Desember 2024.</p>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="news-card">
                                <img src="{{ asset('assets-guest/images/goro.jpg') }}" class="card-img-top" alt="Berita 2" style="height: 200px; object-fit: cover;">
                                <div class="card-body p-4">
                                    <span class="badge bg-success mb-2">Kegiatan</span>
                                    <h5 class="card-title">Gotong Royong Bersih Desa</h5>
                                    <p class="card-text text-muted">Ayo ramaikan kegiatan gotong royong bersih desa pada hari Minggu depan.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="news-card">
                                <img src="{{ asset('assets-guest/images/portal.jpg') }}" class="card-img-top" alt="Berita 3" style="height: 200px; object-fit: cover;">
                                <div class="card-body p-4">
                                    <span class="badge bg-warning mb-2">Pembangunan</span>
                                    <h5 class="card-title">Progress Pembangunan Jalan Desa</h5>
                                    <p class="card-text text-muted">Pembangunan jalan desa sektor timur telah mencapai 75% dan diperkirakan selesai bulan depan.</p>
                                    <div class="d-flex justify-content-between align-items-center">
            ...
            <section class="section" id="programs">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            <span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Program Desa</span>
                            <h2 class="section-title text-center mb-3" data-aos="fade-up" data-aos-delay="100">Program Unggulan untuk Kemajuan Desa</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Berbagai program yang sedang berjalan untuk memajukan desa kita.</p>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="0">
                            <div class="program-card">
                                <div class="d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Program penghijauan dan pelestarian lingkungan desa.</p>
                                    </div>
                                </div>
                            ...
                            <div class="program-card">
                                <div class="d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Program peningkatan literasi digital bagi warga desa.</p>
                                    </div>
                                </div>
                                <div class="progress mb-3" style="height: 8px;">
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-7 mx-auto text-center">
                            ...
                            <p data-aos="fade-up" data-aos-delay="100">Butuh bantuan atau memiliki pertanyaan? Tim kami siap membantu Anda.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
