...
<head>
    ...
    <title>Edit Profil Desa - Binadesa</title>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            <span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Admin
                                Panel</span>
                            <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Edit Profil Desa</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Form untuk mengedit data profil desa.</p>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="form-wrapper" data-aos="fade-up" data-aos-delay="300">
                                <form action="{{ route('profildesa.update', $profil->profil_id) }}" method="POST" class="p-5 rounded-4"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('alamat_kantor') is-invalid @enderror"
                                                ...
                                                rows="3" placeholder="Masukkan alamat lengkap kantor desa" required>{{ old('alamat_kantor', $profil->alamat_kantor) }}</textarea>
                                            @error('alamat_kantor')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('visi') is-invalid @enderror"
                                                id="visi" name="visi"
                                                rows="3" placeholder="Masukkan visi desa" required>{{ old('visi', $profil->visi) }}</textarea>
                                            @error('visi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('misi') is-invalid @enderror"
                                                id="misi" name="misi"
                                                rows="4" placeholder="Masukkan misi desa" required>{{ old('misi', $profil->misi) }}</textarea>
                                            @error('misi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
