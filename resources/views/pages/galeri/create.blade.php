...
<head>
    ...
    <title>Tambah Galeri - Binadesa</title>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            ...
                            <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Tambah Galeri</h2>
                            <p data-aos="fade-up" data-aos-delay="200">Form untuk menambahkan galeri baru ke dalam sistem.</p>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="form-wrapper" data-aos="fade-up" data-aos-delay="300">
                                <form action="{{ route('galeri.store') }}" method="POST" class="p-5 rounded-4"
                                    ...
                                    <div class="row gap-3 mb-4">
                                        <div class="col-md-12">
                                            <label class="mb-2 fw-bold" for="foto">Foto Galeri <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control @error('foto') is-invalid @enderror"
                                                id="foto" type="file" name="foto[]"
                                                accept="image/*" multiple required>
                                            <small class="text-muted">Unggah foto untuk galeri (minimal 1 file, maksimal 10 file, 5MB per file). Format: jpeg, png, jpg, gif, webp</small>
                                            @error('foto')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            @error('foto.*')
