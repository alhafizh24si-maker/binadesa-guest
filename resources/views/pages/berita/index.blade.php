            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-8 mx-auto text-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200">Kelola semua berita yang telah dipublikasikan dalam
                            sistem.</p>
                    </div>
                </div>
                        ...
                        <div class="bg-light p-4 rounded-3">
                            <form method="GET" action="{{ route('berita.index') }}" id="filterForm">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-medium">Cari Berita</label>
                        ...
                        <div class="card border-0 shadow-sm" data-aos="fade-up">
                            <div class="card-body py-3">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3">
                                        <h4 class="text-success mb-1">{{ $publishedCount ?? $berita->where('status', 'terbit')->count() }}</h4>
                                        <small class="text-muted">Berita Terbit</small>
                                    </div>
                                    <div class="col-md-3">
                                        <h4 class="text-warning mb-1">{{ $draftCount ?? $berita->where('status', 'draft')->count() }}</h4>
                                        <small class="text-muted">Berita Draft</small>
                                    </div>
                                    <div class="col-md-3">
                                        <h4 class="text-info mb-1">{{ $categoryCount ?? $berita->unique('kategori_id')->count() }}</h4>
                            ...
                            <div class="col-12">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body text-center py-5">
                                        ...
                                        <p class="text-muted mb-4">Mulai dengan menambahkan berita pertama Anda
                                            untuk ditampilkan di sini.</p>
