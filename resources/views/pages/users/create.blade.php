                ...
                <div class="form-wrapper" data-aos="fade-up" data-aos-delay="300">
                  <form action="{{ route('user.store') }}" method="POST" class="p-5 rounded-4" style="background: var(--bs-body-bg); border: 1px solid var(--bs-border-color);">
                    ...
                    <div class="row gap-3 mb-4">
                      <div class="col-md-12">
                        <label class="mb-2 fw-bold" for="name">Nama Lengkap <span class="text-danger">*</span></label>
                    ...
                    <div class="row gap-3 mb-4">
                      <div class="col-md-12">
                        <label class="mb-2 fw-bold" for="email">Email <span class="text-danger">*</span></label>
